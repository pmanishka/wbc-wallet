...
! function(e) {
    ...
    function t(t, o, i) {
        var r, p, d, f = this,
            ...
            y = "undefined" == typeof w ? "back" : w.indexOf(s.mm("position-top")) > -1 || w.indexOf(s.mm("position-bottom")) > -1 || w.indexOf(s.mm("position-front")) > -1 ? "front" : "back";
        switch (_) {
            case "top":
            case "bottom":
                c.events = "panup pandown", c.typeLower = "y", c.typeUpper = "Y", m = "height"
        }
        switch (_) {
            case "right":
            case "bottom":
                c.negative = !0, u = function(e) {
        ...
        $.on("panstart", function(e) {
            ...
            if (r = e["delta" + c.typeUpper], c.negative && (r = -r), r != v && (l = r >= v ? c.open_dir : c.close_dir), v = r, v > t.threshold && 1 == g) {
                ...
                g = 2, f._openSetup(), f.trigger("open:start"), i.$html.addClass(s.dragging), b = n(i.$wndw[m]() * o[m].perc, o[m].min, o[m].max)
            }
            2 == g && (p = n(v, 10, b) - ("front" == y ? b : 0), c.negative && (p = -p), d = "translate" + c.typeUpper + "(" + p + "px )", x.css({
